...
msg="Invoca la skill task-observer antes del primer tool call y ejecuta su Session Start Protocol (chequeo de storage, scan de frontmatter, trigger de revision). Cargar la skill y correr el protocolo son pasos distintos."
